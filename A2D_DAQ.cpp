...
A2D_DAQ::A2D_DAQ(): io({TCA9539(RESET_PIN, INT_PIN, IO_EXP_I2C_ADDR_START),
						TCA9539(RESET_PIN, INT_PIN, IO_EXP_I2C_ADDR_START+1),
						TCA9539(RESET_PIN, INT_PIN, IO_EXP_I2C_ADDR_START+2),
						TCA9539(RESET_PIN, INT_PIN, IO_EXP_I2C_ADDR_START+3)}),
